...
![Site Ayarları](screenshots/settings.png)

### Admin Panel - Haber Yönetimi (AI Destekli)
![Haber Yönetimi](screenshots/news-manager.png)
...
│   ├── Hero.tsx         # Ana banner ve slider
│   ├── Navbar.tsx       # Navigasyon menüsü
│   ├── Team.tsx         # Takım kadrosu (marquee)
│   ├── VehicleShowcase.tsx  # Araç galerisi
│   ├── Activities.tsx   # Etkinlikler
│   ├── Races.tsx        # Yarışlar
│   ├── Sponsors.tsx     # Sponsorlar
│   ├── Contact.tsx      # İletişim formu
│   └── admin/           # Admin bileşenleri
├── pages/
│   ├── LandingPage.tsx  # Ana sayfa
│   ├── NewsDetail.tsx   # Haber detay
│   ├── ActivityDetail.tsx # Etkinlik detay
